...
# much better! -- but still a bit of yellow in one line:
#   dx = (b-a) / N
# C has different rules for roudning division for negative numbers
#   than python. Cython acts like python unless you tell it not to
#   with the "cdvision" decorator: (you need to import cython for this)
